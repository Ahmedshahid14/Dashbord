...
import SystemLog from '../images/icon/Log Files.svg';
import SystemResources from '../images/icon/System Resources.svg';
import SystemUser from '../images/icon/System Resources.svg';
...
import SystemUserPopup from './SystemUserPopup';
    ...
    <>
      <div className="bg-white rounded-t shadow">
        ...
        <ListItem
          icon={SystemLog}
          title="System Log"
          onClick={() => handlePopupOpen('SystemLog')}
        />
        <ListItem
        ...
        <ListItem
          icon={SystemUser}
          title="System User"
          onClick={() => handlePopupOpen('SystemUser')}
        />
        <ListItem
          icon={FNMLicense}
          title="FNM License"
      ...
      {openPopup === 'SystemLog' && <SystemLogPopup onClose={handlePopupClose} />}
      {openPopup === 'systemResources' && <SystemResourcesPopup onClose={handlePopupClose} />}
      {openPopup === 'SystemUser' && <SystemUserPopup onClose={handlePopupClose} />}
